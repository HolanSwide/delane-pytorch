...
with import_from('./'):
    # Data pipeline
    from configs.common.datasets.culane_bezier import dataset
    from configs.common.datasets.train_level1b_288 import train_augmentation
    ...
    from configs.common.optims.ep36_cosine import lr_scheduler
