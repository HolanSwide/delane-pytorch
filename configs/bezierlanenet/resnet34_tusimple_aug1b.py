...
with import_from('./'):
    # Data pipeline
    from configs.common.datasets.tusimple_bezier import dataset
    from configs.common.datasets.train_level1b_360 import train_augmentation
    from configs.common.datasets.test_360 import test_augmentation

    # Optimization pipeline
    from configs.common.optims.matchingloss_bezier import loss
    from configs.common.optims.adam00006_dcn import optimizer
    from configs.common.optims.ep400_cosine import lr_scheduler
